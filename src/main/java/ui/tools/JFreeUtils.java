...
public class JFreeUtils {
	public static JFreeChart createPieChart(DefaultPieDataset dataset,
			...
			//生成图片
			drawToOutputStream("graphics/chart/柱状图.JPG", chart, 640, 480);
			}
			...
			//生成图片
			drawToOutputStream("graphics/chart/饼图.JPG", chart, 640, 480);
			}
			...
			//生成图片
			drawToOutputStream("graphics/chart/曲线-月.JPG", chart, 640, 480);
			}
			...
			periodType,dateInterval,timeFormat,dataset);
			//生成图片
			drawToOutputStream("graphics/chart/曲线-天.JPG", chart, 640, 480);
			}
			...
			periodType,dateInterval,timeFormat,dataset);
			//生成图片
			drawToOutputStream("graphics/chart/曲线-小时.JPG", chart, 640, 480);
			}
