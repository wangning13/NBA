...
public class MyTable extends JTable {
	...
	/*
	 * public void setComboCell(int r,int c,TableCellEditor ce){ this.myRow=r;
	 * this.myCol=c; this.myEditor=ce; }
	 */
	...
	public void setWidth() {
		for (int i = 0; i < this.getColumnCount(); i++) {
			int with = this.getPreferredWidthForCloumn(this, i) + 5;
			with = 90 > with ? 90 : with;
			this.getColumnModel().getColumn(i).setPreferredWidth(with);
		}
	}
	//
	 ...
	 * if(row==myRow&&column==myCol&&myEditor!=null) return myEditor; return
