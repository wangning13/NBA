...
public class Img {
	public static final Image CLOSE2 = new ImageIcon("graphics/main/close2.png")
			.getImage();
	public static final Image MINI2 = new ImageIcon("graphics/main/mini2.png")
			.getImage();
	public static final Image CLOSE1 = new ImageIcon("graphics/main/close1.png")
			.getImage();
	public static final Image MINI1 = new ImageIcon("graphics/main/mini1.png")
			.getImage();
	...
	public static final ImageIcon RANKINGBAND = new ImageIcon(
			"graphics/ranking/band.png");
	public static final ImageIcon MATCHBAND = new ImageIcon(
			"graphics/match/band.png");
	public static final Image HOME1 = new ImageIcon("graphics/main/home1.png")
			.getImage();
	public static final Image HOME2 = new ImageIcon("graphics/main/home2.png")
			.getImage();
	...
	public static final Image BACK1 = new ImageIcon("graphics/main/back1.png")
			.getImage();
	public static final Image BACK2 = new ImageIcon("graphics/main/back2.png")
			.getImage();
	public static final Image RANKICON1 = new ImageIcon("graphics/main/排名1.png")
			.getImage();
	public static final Image RANKICON2 = new ImageIcon("graphics/main/排名2.png")
			.getImage();
	public static final Image STATISTICSICON1 = new ImageIcon(
			"graphics/main/统计1.png").getImage();
	public static final Image STATISTICSICON2 = new ImageIcon(
			"graphics/main/统计2.png").getImage();
	public static final Image TEAMICON1 = new ImageIcon("graphics/main/球队1.png")
			.getImage();
	public static final Image TEAMICON2 = new ImageIcon("graphics/main/球队2.png")
			.getImage();
	public static final Image PLAYERICON1 = new ImageIcon(
			"graphics/main/球员1.png").getImage();
	public static final Image PLAYERICON2 = new ImageIcon(
			"graphics/main/球员2.png").getImage();
	public static final Image MATCHICON1 = new ImageIcon(
			"graphics/main/比赛1.png").getImage();
	public static final Image MATCHICON2 = new ImageIcon(
