...
public class testGetTeamData {
	public static void main(String[] args) {
		...
		// teamRank.getTeamData("13-14","`partition`='Atlantic'", "wins",
		// "DESC");
		// for (int i = 0; i < teamVOs.size(); i++) {
		// System.out.println(teamVOs.get(i).getAssistEfficiency());
		// }

		// ArrayList<TeamMonthMatchVO> teamMonthMatchVOs =
		// teamRank.getTeamMonthMatch("13-10", "LAL");
		...
		for (int i = 0; i < teamVOs.size(); i++) {
			...
			System.out
					.println(teamVOs.get(i).getDefensivebackboardEfficiency());
		...
		// ArrayList<TeamMonthMatchVO> teamMonthMatchVOs =
		// teamRank.getTeamRecentFiveMatch("LAL");
