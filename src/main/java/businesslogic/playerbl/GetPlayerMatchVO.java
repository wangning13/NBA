...
public class GetPlayerMatchVO {
	public PlayerMatchVO getPlayerMatchVO(PlayerMatchPO playerMatchPO) {
		PlayerMatchVO playerMatchVO = new PlayerMatchVO(
				playerMatchPO.getDate(), playerMatchPO.getTeam(),
				playerMatchPO.getPlayername(), playerMatchPO.getPosition(),
				playerMatchPO.getMinutes(), playerMatchPO.getFieldGoal(),
				...
				playerMatchPO.getBackboard(), playerMatchPO.getAssist(),
				playerMatchPO.getSteal(), playerMatchPO.getBlock(),
				playerMatchPO.getTurnOver(), playerMatchPO.getFoul(),
