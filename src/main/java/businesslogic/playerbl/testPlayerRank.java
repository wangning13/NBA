...
public class testPlayerRank {
	public static void main(String[] args) {
		...
		// ArrayList<PlayerMatchVO> playerMatchVOs =
		// playerRank.getPlayerMatchdata("13-10-29", "LAL");
		...
		// ArrayList<PlayerMatchVO> playerMatchVOs2 =
		// playerRank.getPlayerMonthMatch("13-10", "Ed Davis");
		...
		// ArrayList<PlayerMatchVO> playerMatchVOs =
		// playerRank.getPlayerRecentFiveMatch("Ed Davis");
		// for (int i = 0; i < playerMatchVOs.size(); i++) {
		// System.out.println(playerMatchVOs.get(i).getDate());
		// }

		// ArrayList<PlayerMatchVO> playerMatchVOs =
		// playerRank.getDayTop("13-10-29", "backboard");
		// for (int i = 0; i < playerMatchVOs.size(); i++) {
		// System.out.println(playerMatchVOs.get(i).getPlayername());
		...
		ArrayList<PlayerVO> playerVOs = playerRank.getSeasonTop("13-14",
				"backboard");
		...
		// ArrayList<PlayerVO> playerVOs = playerRank.getAllPlayerdata("13-14",
		// "backboard", "DESC");
		// System.out.println(playerVOs.size());
		// for (int i = 0; i < playerVOs.size(); i++) {
		// System.out.println(playerVOs.get(i).getMinutes());
