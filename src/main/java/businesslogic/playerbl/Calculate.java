...
public class Calculate {
	...
	public PlayerPO Calculate(PlayerPO playerPO){
		...
		playerPO.setEfficiency(Double.parseDouble(df3.format((playerPO.getScoring()+playerPO.getBackboard()+playerPO.getAssist()+playerPO.getSteal()+playerPO.getBlock())-(playerPO.getFreeThrowAttempts()-playerPO.getFreeThrow())-playerPO.getTurnOver())));
